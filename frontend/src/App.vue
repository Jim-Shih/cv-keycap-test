<template>
  <div>
    ...
    <div class="image-container">
      <img :src="uploadedImage" alt="Uploaded Image" v-if="uploadedImage" class="half-width" />
      <img :src="processedImage" alt="Processed Image" v-if="processedImage" class="half-width" />
    </div>
  </div>
</template>
